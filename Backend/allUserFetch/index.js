...
const initializeUsersFile = () => {
  if (!fs.existsSync(usersFilePath)) {
    const initialUsers = [
      ...
      { id: 3, username: "alice_johnson", password: "alicepassword" },
      { id: 4, username: "bob_brown", password: "bobbrownpassword" },
      { id: 5, username: "charlie_white", password: "charliepassword" }
    ];
